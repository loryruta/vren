...
#define VREN_DEFINE_VK_RAII(_raii_t, _t, _dtor_lambda)                                                                 \
    ...
    {                                                                                                                  \
        using _raii_t = vren::vk_handle_wrapper<_t>;                                                                   \
                                                                                                                       ...
                                                                                                                       \
    template <> inline void vren::destroy_vk_handle(vren::context const& ctx, _t handle)                               \
    {                                                                                                                  \
...
namespace vren
{
    ...
    template <typename T> void destroy_vk_handle(vren::context const& ctx, T handle);

    template <typename _t> class vk_handle_wrapper
    {
    private:
    ...
    public:
        ...
        vk_handle_wrapper(vren::vk_handle_wrapper<_t>&& other) noexcept :
...
VREN_DEFINE_VK_RAII(
    vk_image,
    VkImage,
    [](vren::context const& ctx, VkImage handle)
    {
...
VREN_DEFINE_VK_RAII(
    vk_image_view,
    VkImageView,
    [](vren::context const& ctx, VkImageView handle)
    {
...
VREN_DEFINE_VK_RAII(
    vk_sampler,
    VkSampler,
    [](vren::context const& ctx, VkSampler handle)
    {
...
VREN_DEFINE_VK_RAII(
    vk_framebuffer,
    VkFramebuffer,
    [](vren::context const& ctx, VkFramebuffer handle)
    {
...
VREN_DEFINE_VK_RAII(
    vk_render_pass,
    VkRenderPass,
    [](vren::context const& ctx, VkRenderPass handle)
    {
...
VREN_DEFINE_VK_RAII(
    vk_buffer,
    VkBuffer,
    [](vren::context const& ctx, VkBuffer handle)
    {
...
VREN_DEFINE_VK_RAII(
    vk_semaphore,
    VkSemaphore,
    [](vren::context const& ctx, VkSemaphore handle)
    {
...
VREN_DEFINE_VK_RAII(
    vk_fence,
    VkFence,
    [](vren::context const& ctx, VkFence handle)
    {
...
VREN_DEFINE_VK_RAII(
    ...
    VkDescriptorSetLayout,
    [](vren::context const& ctx, VkDescriptorSetLayout handle)
    {
...
VREN_DEFINE_VK_RAII(
    vk_query_pool,
    VkQueryPool,
    [](vren::context const& ctx, VkQueryPool handle)
    {
...
VREN_DEFINE_VK_RAII(
    vk_shader_module,
    VkShaderModule,
    [](vren::context const& ctx, VkShaderModule handle)
    {
...
VREN_DEFINE_VK_RAII(
    vk_pipeline,
    VkPipeline,
    [](vren::context const& ctx, VkPipeline handle)
    {
...
VREN_DEFINE_VK_RAII(
    vk_pipeline_layout,
    VkPipelineLayout,
    [](vren::context const& ctx, VkPipelineLayout handle)
    {
...
VREN_DEFINE_VK_RAII(
    vk_command_pool,
    VkCommandPool,
    [](vren::context const& ctx, VkCommandPool handle)
    {
...
VREN_DEFINE_VK_RAII(
    vk_descriptor_pool,
    VkDescriptorPool,
    [](vren::context const& ctx, VkDescriptorPool handle)
    {
...
VREN_DEFINE_VK_RAII(
    vk_surface_khr,
    VkSurfaceKHR,
    [](vren::context const& ctx, VkSurfaceKHR handle)
    {
...
VREN_DEFINE_VK_RAII(
    vma_allocation,
    VmaAllocation,
    [](vren::context const& ctx, VmaAllocation handle)
    {
