...
namespace vren
{
    // All the following GPU structures are at least 16 bytes aligned (supporting minStorageBufferOffsetAlignment <=
    // 16).
    ...
    struct meshlet
    {
        ...
        uint32_t m_triangle_count;  // The number of triangles of the meshlet (actual uint8_t count will be
                                    // m_triangle_count * 3)
