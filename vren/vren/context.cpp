...
void vren::context::print_nv_mesh_shader_info(VkPhysicalDeviceMeshShaderPropertiesNV const& props)
{
    ...
    printf(
        "maxTaskWorkGroupSize: (%d, %d, %d)\n",
        props.maxTaskWorkGroupSize[0],
        props.maxTaskWorkGroupSize[1],
        props.maxTaskWorkGroupSize[2]
    );
    ...
    printf(
        "maxMeshWorkGroupSize: (%d, %d, %d)\n",
        props.maxMeshWorkGroupSize[0],
        props.maxMeshWorkGroupSize[1],
        props.maxMeshWorkGroupSize[2]
    );
...
VkInstance vren::context::create_instance()
{
    ...
    layers.insert(layers.end(), {"VK_LAYER_KHRONOS_validation"});
