...
namespace vren
{
    ...
    public:
        inline VkDescriptorPool get_descriptor_pool() const { return m_descriptor_pool.m_handle; }

        inline VkRenderPass get_render_pass() const { return m_render_pass.m_handle; }
